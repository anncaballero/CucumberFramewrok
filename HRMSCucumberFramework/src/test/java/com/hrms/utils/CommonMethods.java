...
public class CommonMethods extends PageInitializer {
	...
	public static byte[] takeScreenShot(String fileName) {
		...
		//create a picture in a form of bytes --> we need it to attach it to 
	...
	public static void selectDdValue(WebElement element, int index) {
		...
		if (!isFound) {
			System.out.println("Value with index" + index + "was not found in the dropdown");
		}
	}
	...
	/**
	 * This method read Json formatted files
	 */
