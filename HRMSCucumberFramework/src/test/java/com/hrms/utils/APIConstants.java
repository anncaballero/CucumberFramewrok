...
public class APIConstants {
	...
	public static final String GenerateToken="http://18.232.148.34/syntaxapi/api/generateToken.php";
	...
	public static final String UPDATE_EMPLOYEE_JSON = "/src/test/resources/JSONFiles/updateEmployee.json";
	
	public static final String STORE_JSON = "/src/test/resources/JSONFiles/store.json";
